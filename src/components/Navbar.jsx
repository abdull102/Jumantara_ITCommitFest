...
export default function Navbar() {
  ...
  return (
    <header className="py-4 xl:py-0 sticky top-4 z-50 xl:-mt-6">
      <nav className="hidden xl:flex justify-center items-center">
        <div className="w-fit flex items-center gap-48 my-5 bg-zinc-900/50 backdrop-blur-2xl rounded-full px-2">
          <Link to="/">
      ...
      {/* Mobile Navbar */}
      <motion.nav
        className={`xl:hidden flex justify-between items-center mx-4 bg-zinc-800 px-6 py-2 ${
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            className="xl:hidden mx-4 p-4 bg-zinc-800 rounded-b-2xl -mt-2"
