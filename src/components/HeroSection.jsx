  ...
  return (
    <Container className="flex flex-col md:flex-row justify-between md:items-center overflow-clip">
      <div className="z-10">
        ...
        <h1 className="font-bold text-3xl lg:text-6xl mt-4 leading-snug 2xl:w-200">
          {title.map((word, i) => (
            <motion.span
              key={i}
        ...
        <motion.p
          ...
          className="mt-4 text-sm lg:text-lg text-zinc-400 md:w-130 lg:w-160"
        >
        ...
        <motion.div
          ...
          className="flex items-center gap-4 mt-6 lg:mt-12"
        >
          <motion.button
          ...
          >
            <HashLink
              smooth
              to="#introduction"
              className="px-4 py-2.5 lg:px-8 lg:py-3 text-sm lg:text-base rounded-xl bg-violet-500 hover:bg-violet-600 transition"
            >
          ...
          >
            <HashLink
              ...
              className="px-4 py-2.5 lg:px-8 lg:py-3 text-sm lg:text-base rounded-xl border-[1.5px] border-zinc-700 hover:bg-zinc-50 hover:text-violet-500 transition"
            >
