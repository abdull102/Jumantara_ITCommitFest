...
export default function SectionAncaman() {
  ...
  return (
    <Container id="generalthreats">
      ...
      >
        ...
        >
          <h2 className="text-violet-400 text-sm lg:text-base uppercase font-medium">
            Ancaman Umum
          </h2>
          <h1 className="font-bold text-2xl lg:text-5xl lg:w-120">
            Kenali Taktik Penjahat Siber
          </h1>
        </motion.div>
        <motion.p
          variants={fadeRight}
          className="text-zinc-400 text-sm lg:text-base md:w-88 lg:w-110 2xl:w-140 md:text-right"
        >
      ...
      >
        ...
        <motion.div
          variants={fadeUp}
          className="flex flex-col items-start gap-3 p-6 md:w-full lg:w-180 2xl:w-248 bg-zinc-800 rounded-xl"
        >
          <img src="/img/phising.svg" className="h-48" />
          <h3 className="font-semibold text-2xl 2xl:text-3xl mt-18">
            Phishing
          </h3>
          <p className="text-zinc-400 text-sm lg:text-base 2xl:text-lg">
        ...
        <motion.div
          variants={fadeUp}
          className="flex flex-col items-start gap-3 p-6 md:w-full lg:flex-1 2xl:w-160 bg-zinc-800 rounded-xl"
        >
  ...
  function CardBottom({ title, description, img }) {
    ...
    return (
      <motion.div
        variants={fadeUp}
        className="flex flex-col items-start gap-3 p-6 md:w-full lg:flex-1 2xl:w-204 bg-zinc-800 rounded-xl"
      >
        {renderImg()}
