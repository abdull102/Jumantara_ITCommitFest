...
export default function SectionKebiasaan() {
  ...
  return (
    <Container id="goodpractices">
      <div className="flex flex-col-reverse lg:flex-row lg:justify-between items-start gap-6">
        <div className="flex flex-col gap-1 lg:gap-2 w-full lg:w-180">
            ...
            >
              ...
              >
                <div className="flex items-center gap-3">
                  {getIconById(data.id)}
                  <h2 className="font-medium lg:text-lg 2xl:text-xl">
                    {data.title}
                  </h2>
                </div>
                <Chevron
              ...
              <AnimatePresence initial={false}>
                {open === data.id && (
                  ...
                  >
                    <p className="mt-4 text-zinc-400 lg:text-lg 2xl:text-xl">
                      {data.desc}
                    </p>
                  </motion.div>
                )}
        ...
        {/* Judul dan Subjudul */}
        <motion.div
          className="flex flex-col lg:justify-between lg:items-end gap-6 lg:text-right"
          initial="hidden"
          whileInView="show"
        ...
        >
          ...
          <motion.p
            variants={fadeRight}
            className="text-zinc-400 text-sm lg:text-base lg:w-140"
          >
