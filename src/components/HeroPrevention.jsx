  ...
  return (
    <Container className="relative flex justify-center items-center">
      <motion.img
        ...
        className="absolute top-58 lg:top-78 inset-0 z-0 w-full h-full object-cover pointer-events-none opacity-80"
      />
      ...
      >
        ...
        <motion.h1
          ...
          className="font-bold text-4xl lg:text-6xl mt-4 lg:w-180"
        >
        ...
        <motion.p
          ...
          className="mt-4 text-sm lg:text-lg text-zinc-400 lg:w-160"
        >
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.96 }}
            className="px-4 lg:px-8 py-2.5 lg:py-3 rounded-xl bg-violet-500 hover:bg-violet-600 cursor-pointer"
          >
          ...
          <motion.button
            whileHover={{ scale: 1.06 }}
            whileTap={{ scale: 0.96 }}
            className="px-4 lg:px-8 py-2.5 lg:py-3 rounded-xl border-[1.5px] border-zinc-700 hover:bg-zinc-700 cursor-pointer"
          >
