  ...
  return (
    <Container id="introduction" className="2xl:mt-46">
      ...
      >
        ...
        <p className="text-zinc-400 text-sm lg:text-base 2xl:text-lg md:w-160 lg:w-200 2xl:w-220 text-center">
  ...
  function Card({ title, description, icons }) {
    ...
    return (
      <motion.div
        ...
        className="flex flex-col items-start gap-3 p-6 border-[1.5px] w-120 md:w-full lg:flex-1 2xl:w-130 border-zinc-800 bg-zinc-800 rounded-xl"
      >
        {renderIcon()}
