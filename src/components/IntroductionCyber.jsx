  ...
  return (
    <Container id="simulation" className="mt-64 pb-0">
      <motion.article
        ...
        className="flex flex-col lg:flex-row justify-between items-start gap-6 lg:gap-24"
      >
        <section className="flex flex-col gap-6">
          ...
          >
            <p className="text-zinc-400 2xl:text-lg lg:w-130 2xl:w-180">
              Ancaman siber itu tindakan jahat yang berusaha mencuri data, uang,
              atau akses perangkat kamu lewat internet, aplikasi, pesan.
            </p>
            <p className="text-zinc-400 2xl:text-lg lg:w-130 2xl:w-180 mt-1 2xl:mt-2">
          ...
          <motion.h2
            ...
            className="font-semibold text-lg lg:text-2xl mt-4"
          >
