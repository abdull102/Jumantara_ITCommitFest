...
export default function FaqSection() {
  ...
  return (
    <Container id="faq">
      <section className="flex flex-col lg:flex-row justify-between lg:items-center lg:gap-60 2xl:gap-120">
        {/* Title */}
        <motion.div
        ...
        >
          <div>
            <p className="font-medium text-lg lg:text-xl text-violet-400">
              Tanya Jawab
            </p>

            <motion.h1
              className="mt-4 lg:mt-6 font-medium text-2xl lg:text-4xl 2xl:text-5xl"
            ...
            <motion.p
              className="mt-4 lg:mt-6 text-sm lg:text-base text-zinc-400 lg:w-120"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
          ...
          {/* Button Contact Us */}
          <motion.div
            className="hidden lg:block p-6 rounded-xl bg-zinc-800 mt-28 2xl:mt-32"
          ...
          >
            <h1 className="font-semibold lg:text-lg">Masih belum terjawab?</h1>
            <p className="mt-2 text-sm lg:text-base text-zinc-400">
              Tanya melalui email, biar bisa kami bantu ya
            </p>

            <a
              href="mailto:test@email.com"
              className="p-2 pl-4 lg:pl-6 flex items-center gap-4 mt-6 bg-white hover:bg-zinc-200 rounded-full w-fit group"
            >
        ...
        {/* Content */}
        <motion.div
          className="flex flex-col  flex-1 mt-12 lg:mt-6"
          initial={{ opacity: 0, y: 40, filter: "blur(6px)" }}
          whileInView={{ opacity: 1, y: 0, filter: "blur(0px)" }}
          transition={{ duration: 0.7, ease: "easeOut" }}
          viewport={{ once: true }}
        >
          {faqData.map((faq) => (
            ...
            >
              ...
              >
                <h2 className="font-medium lg:text-lg">{faq.title}</h2>
        ...
        {/* Mobile Contact Box */}
        <motion.div
          className="lg:hidden p-6 rounded-xl bg-zinc-800 mt-12"
