    ...
    <main className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="max-w-3xl mx-auto bg-white p-6 md:p-10 rounded-lg shadow-lg">
        ...
        <section>
          ...
          <p className="text-gray-700 leading-relaxed">
            Logo pada simulasi siber website ini disediakan oleh{" "}
            <a
          ...
          <p className="text-gray-700 leading-relaxed mt-2">
            Logo-logo ini dapat digunakan secara gratis untuk tujuan
            demo simulasi dan tidak memerlukan atribusi, tetapi atribusi ini
            disediakan sebagai informasi.
          </p>
        </section>
      </div>
    </main>
